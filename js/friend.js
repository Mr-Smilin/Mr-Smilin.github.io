...
$(function () {
	...
	$.getJSON("../json_data/friend.json", function (data) {
		...
		$(".links-content").append(
			"<div class='friend-title-item'><br>大佬們<br><br><hr></div>"
		);
		$.each(data, function (i, e) {
			var html = '<div class="friend-card-item">';
			if (e.src == undefined) {
				html +=
					'    <img class="ava" src="/img/links/nopic.jpg" title="圖片連結不可用時的默認圖片">';
			} else {
		...
		if (notValid.length > 0) {
			$(".links-content").append(
				"<div class='friend-title-item'><br>異常的大佬們<br><br><hr></div></div>"
			);
